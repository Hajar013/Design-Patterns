    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
             ...
             Route GetWalkingRoute(string origin, string destination)
            {
                // complex process
                return new Route
                {
                    ...
                    Directions = new List<string>()
        {
            ...
            destination
             ...
             Route GeCyclingRoute(string origin, string destination)
            {
                return new Route
                {
                    ...
                    Directions = new List<string>()
        {
            ...
            destination
             ...
             Route GetDrivingRoute(string origin, string destination)
            {
                return new Route
                {
                    Title = "via l-87 S",
                    ...
                    Directions = new List<string>() 
                    { origin, "Head southeast on Blvd Robert-Bourassa toward Boulevard René-Lévesque O/Bd René-Lévesque [3 min.] (1.1 km)", "Follow A 15 S, I-87 S and NJ-17 S to Holland Tunnel in Jersey City, United States [5 hr 43 min.] (590 km)", "Continue on Holland Tunnel to your destination in Manhattan, New York [10 min.] (4.6 km)", destination }
                };
            }

            Route GetTransitRoute(string origin, string destination)
            {
                return new Route
                {
                    Title = "Greyhound",
                    ...
                    Directions = new List<string>()
        {
            ...
            Route GetFlightRoute(string origin, string destination)
            {
                return new Route
                {
                    ...
                    Directions = new List<string>() { origin, "Montréal-Pierre Elliott Trudeau International Airport (YUL)", "John F. Kennedy International Airport (JFK)", destination }
                };
            }
